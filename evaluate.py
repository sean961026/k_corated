...
def RMSE(test_set_file_name, base_ratings_file_name, web_name, nearest_neighbor_size):
    ...
    for i in range(size):
        ...
        predicted_rating = pd_rating(original_ratings, test_user, test_item, web, nearest_neighbor_size)
...
def main():
    ...
    ans = RMSE(test_set_file_name, data_set + '_ratings.csv', web_name, nearest_neighbor_size)
